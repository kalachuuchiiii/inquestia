...
const AppSidebar = () => {
  ...
  return (
    <div className=" sticky top-0 w-3/12  ">
      <div className="rounded relative  w-full scrollbar-none  bottom-0 z-50">
       {
        ...
        <aside className=" overflow-y-auto h-screen w-full scrollbar-none dark:bg-zinc-950  ">
          <nav className=" w-full flex items-start  h-full mx-auto  scrollbar-none">
            <SidebarNav />
          </nav>
        </aside>
      </div>
