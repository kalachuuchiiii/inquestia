...
authRouter.get(
  ...
  catchErrors(authController.getAccount)
);
...
authRouter.post(
  ...
  catchErrors(authMiddleware.verifyAccessToken),
  catchErrors(authController.updatePasswordRequest)
);
authRouter.post(
  "/verify-update-password-code",
  catchErrors(authMiddleware.verifyAccessToken),
  catchErrors(authController.verifyUpdatePasswordRequestCode)
);
authRouter.post(
  "/update-password",
  catchErrors(authMiddleware.verifyAccessToken),
