...
return <div className = "p-3 py-6 w-full shrink-0 rounded-2xl active:scale-103 transition-transform duration-200 shadow-md space-y-6">
  ...
  <div className = "w-full grid grid-cols-10 grid-rows-8 ml-3 rounded-lg h-60">
