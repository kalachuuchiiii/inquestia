...
/** Survey question data with select-type choices */
...
/**
 * SurveyStatistics Component
 * 
 * Displays survey question responses with interactive chart visualization.
 * Features:
 * - Multiple chart types (Bar, Pie, Doughnut)
 * - Data labels showing percentages and counts
 * - Navigation between questions
 * - Download chart as PNG image
 * 
 * @component
 * @param {SurveyStatisticsProps} props - Component props
 * @returns {JSX.Element} Rendered survey statistics visualization
 */
const SurveyStatistics: FC<SurveyStatisticsProps> = ({ data = null }) => {
  ...
  const getChartData = (questionData: SelectTypeQuestion) => ({
    labels: questionData.choices.map((c: Choice) => c.choice),
    datasets: [
      {
        label: "Responses (%)",
