      ...
      Array(number).fill('').map((_, i) => <div className="animate-pulse duration-200 p-2 flex flex-col items-center justify-start gap-2" key={i}>
        <div className="flex gap-2 w-full">
          ...
          <div className=" w-full flex flex-col gap-1">
            <div className="w-10/12 h-3 rounded-lg  bg-zinc-700" />
            <div className="w-8/12 opacity-70 h-3 rounded-lg bg-zinc-700" />
          </div>
        </div>
        <div className="w-full h-8 rounded-lg bg-zinc-700">
