...
const UsersWithSameInterests = () => {
  ...
  return (
    <div className='w-2/4 top-0 sticky right-0 h-screen p-4 hidden lg:block'>
        ...
        <h2 className='font-semibold text-lg my-4'>Users with similar interests</h2>
        <p className='text-sm text-gray-500 dark:text-gray-400 mb-4'>Connect with users who share your interests and explore new perspectives.</p>
        <hr className='mb-4' />
        <div>
            {
               users.length > 0 && users.map(user => (
                <div key={user._id} className='p-2 border-b border-neutral-200 dark:border-neutral-800'>
                    <UserIcon user = {user}>
