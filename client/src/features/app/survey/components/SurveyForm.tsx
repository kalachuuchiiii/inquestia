      ...
      <main>
        ...
        <Item>
          <ItemContent>
            ...
            <ItemDescription>
              {surveyForm.tags.map(_capitalize).join(", ")}
            </ItemDescription>
          </ItemContent>
          <ItemActions>
            <Dialog>
                ...
                <ScrollArea className="w-full h-[70vh] ">
                  {TAGS_ENUM.map((tag) => (
                    <Button
                      ...
                      className={`${
                        surveyForm.tags.includes(tag) ? "inquestia-button" : ""
                      } rounded-lg m-1`}
                      variant="outline"
                    >
                      {_capitalize(tag)}
        ...
        <footer className="my-4 items-center flex justify-end gap-6">
          ...
          <Dialog>
            <DialogContent>
              ...
              <DialogFooter>
                <Button onClick={handleAddTextTypeQuestion}>Open-ended</Button>
                <Button onClick={handleAddSelectTypeQuestion}>
                  Choice-based
                </Button>
              </DialogFooter>
            </DialogContent>
            <DialogTrigger>
              <Button className="inquestia-button">Add question</Button>
            </DialogTrigger>
          </Dialog>
          {surveyForm.isDraft ? (
            <Button
            ...
            <Dialog>
              <DialogContent>
                ...
                <DialogFooter>
                  ...
                  <Button className="inquestia-button">Publish</Button>
                </DialogFooter>
              </DialogContent>
              <DialogTrigger>
                <Button
