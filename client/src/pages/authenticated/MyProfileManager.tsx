...
import { EyeOffIcon, Image, LucideChartNetwork, MailCheckIcon, Pencil, Waypoints } from "lucide-react";
import {
  Item,
  ItemActions,
  ItemContent,
  ...
  return (
    <div className="w-full pt-8 lg:flex gap-4 mx-auto">
      ...
      <main className="w-full">
        ...
        <Item>
          <ItemContent>
            <ItemTitle> <Waypoints /> Social Links</ItemTitle>
            {user.socialLinks.length > 0 ? (
              user.socialLinks.map((s) => <ItemDescription>{s}</ItemDescription>)
            ) : (
