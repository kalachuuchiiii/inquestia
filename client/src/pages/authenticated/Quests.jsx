...
return <div className = "p-2 space-y-4">
  <div className = "mt-6 p-2 mb-10">
   <h1 className = "text-5xl lato">Your Weekly Quests</h1>
  <p className = "text-base  ">Completing quests helps you earn points and climb the leaderboard. The more quests you finish, the closer you get to reaching the top and unlocking recognition for your activity and consistency.</p>
  </div>
