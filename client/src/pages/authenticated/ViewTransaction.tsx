...
const ViewTransaction = () => {
  ...
  const { data: transaction, isLoading, error } = useQuery({
    ...
    queryFn: async() => {
     const res = await api.get(`/api/admin/transaction/${transactionId}`)
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-zinc-600 dark:text-zinc-400">
              {transaction.candidate?.username || transaction.candidate?._id}
            </span>
          </div>
          <div className="flex justify-between items-center">
            <span className="font-semibold text-zinc-700 dark:text-zinc-200">
          ...
          {transaction.status === "rejected" && (
            <div className="mt-6">
              ...
              <ul className="list-disc list-inside text-xs text-zinc-400 space-y-1 pl-2">
                ...
                <li>
                  Spamming or submitting multiple requests in a short period
                </li>
