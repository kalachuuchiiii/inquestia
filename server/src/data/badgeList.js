exports.badges = [
  ...
  { badge: "Research Deity", pointsRequired: 340000, style: "text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 via-violet-400 to-blue-400 font-bold shadow-[0_0_20px_rgba(150,90,255,0.8)] animate-pulse drop-shadow-lg" },
    { badge: "Survey Immortal", pointsRequired: 340000, style: "text-violet-500 bbh-sans-bartle-regular rounded-xl dark:text-violet-300 dark:shadow-[0_0_15px_rgba(130,80,255,0.45)] shadow-[0_0_15px_rgba(167,139,250,0.6)] backdrop-brightness-200 animate-pulse px-2" },
];
