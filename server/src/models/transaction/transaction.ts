...
import { AMOUNT_ENUM, AMOUNT_MSG, PHONE_NUMBER_MAX, PHONE_NUMBER_MIN, PHONE_NUMBER_MSG, STATUS_ENUM, STATUS_MSG } from "@shared/constants";
import { ITransaction } from "@shared/types";
  ...
  const transactionSchema = new mongoose.Schema<ITransaction & Document>({
    candidate: {
